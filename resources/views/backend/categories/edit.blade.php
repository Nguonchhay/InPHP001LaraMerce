                    ...
                    <div class="col-md-9">
                        ...
                        <form method="POST" action="{{ route('backend.categories.update', $category->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" required id="title" name="title" value="{{ $category->title }}">
                            </div>
                            <div class="mb-3">
                                <div class="form-check">
                                    <input {{ $category->highted ? 'checked' : '' }} class="form-check-input" type="checkbox" value="1" name="highted" id="highted">
